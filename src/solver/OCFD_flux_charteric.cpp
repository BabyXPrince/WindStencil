	...
	switch(flagxyz.x){
		...
		case 4:
          {
		     if(flagxyz.x == 4 && flagxyz.z == 1 && coords.x == 1){
		     	get_SoA(du, x-LAP, y-LAP, z-LAP, num) += 0;
                    ...
                    if((flagxyz.x == 4 && coords.x == 1) || (flagxyz.y == 4 && coords.x == job.end.x-job.start.x-1)){
                         get_SoA(du, x-LAP, y-LAP, z-LAP, num) += -get_Field_LAP(Ajac, x, y, z)*tmp/hx_d;
                    }else{
		...
		if(flagxyz.x == 5 && flagxyz.z == 1 && coords.y == 1){
			get_SoA(du, x-LAP, y-LAP, z-LAP, num) += 0;
               ...
               if((flagxyz.x == 5 && coords.y == 1) || (flagxyz.y == 5 && coords.y == job.end.y-job.start.y-1)){
                    get_SoA(du, x-LAP, y-LAP, z-LAP, num) += -get_Field_LAP(Ajac, x, y, z)*tmp/hy_d;
               }else{  
		...
		if(flagxyz.x == 6 && flagxyz.z == 1 && coords.z == 1){
			get_SoA(du, x-LAP, y-LAP, z-LAP, num) += 0;
               ...
               if((flagxyz.x == 6 && coords.z == 1) || (flagxyz.y == 6 && coords.z == job.end.z-job.start.z-1)){
                    get_SoA(du, x-LAP, y-LAP, z-LAP, num) += -get_Field_LAP(Ajac, x, y, z)*tmp/hz_d;
               }else{
	...
	switch(flagxyz.x){
		...
		if(flagxyz.y == 4 && flagxyz.z == 1 && coords.x == job.end.x-job.start.x-1){
			get_SoA(du, x-LAP-1, y-LAP, z-LAP, num) += 0;
               ...
               if((flagxyz.x == 4 && coords.x == 1) || (flagxyz.y == 4 && coords.x == job.end.x-job.start.x-1)){
                    get_SoA(du, x-LAP-1, y-LAP, z-LAP, num) += -get_Field_LAP(Ajac, x-1, y, z)*tmp/hx_d;
               }else{
		...
		if(flagxyz.y == 5 && flagxyz.z == 1 && coords.y == job.end.y-job.start.y-1){
			get_SoA(du, x-LAP, y-LAP-1, z-LAP, num) += 0;
               ...
               if((flagxyz.x == 5 && coords.y == 1) || (flagxyz.y == 5 && coords.y == job.end.y-job.start.y-1)){
                    get_SoA(du, x-LAP, y-LAP-1, z-LAP, num) += -get_Field_LAP(Ajac, x, y-1, z)*tmp/hy_d;
               }else{
		...
		if(flagxyz.y == 6 && flagxyz.z == 1 && coords.z == job.end.z-job.start.z-1){
			get_SoA(du, x-LAP, y-LAP, z-LAP-1, num) += 0;
               ...
               if((flagxyz.x == 6 && coords.z == 1) || (flagxyz.y == 6 && coords.z == job.end.z-job.start.z-1)){
                    get_SoA(du, x-LAP, y-LAP, z-LAP-1, num) += -get_Field_LAP(Ajac, x, y, z-1)*tmp/hz_d;
               }else{
     ...
     cudaJobPackage job)
{
	...
	for(int i = 0; i < 5; i++){
		...
		flag = get_data_kernel(flagxyzb.x, &coords, f, i, &stencil[8*i], ia1, ib1, job);
