...
void bc_user_Liftbody3d_init()
{
    ...
    // hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Sin_AOA_d) ), &Sin_AOA , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    // hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Cos_AOA_d) ), &Cos_AOA , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    // hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(TW_d) ), &TW , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
