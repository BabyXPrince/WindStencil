...
void opencfd_mem_init_dev(){
    ...
    new_cudaSoA( &pf_lap_d , nx+2*LAP , ny+2*LAP , nz+2*LAP);//used by filtering
    new_cudaSoA( &pfp_d , nx+2*LAP , ny+2*LAP , nz+2*LAP);
    new_cudaSoA( &pfm_d , nx+2*LAP , ny+2*LAP , nz+2*LAP);

    new_cudaSoA( &pfp_outerX_d , 4*LAP, ny+2*LAP, nz+2*LAP);
    new_cudaSoA( &pfp_outerY_d , nx+2*LAP, 4*LAP, nz+2*LAP);
    new_cudaSoA( &pfp_outerZ_d , nx+2*LAP, ny+2*LAP, 4*LAP);

    new_cudaSoA( &pfm_outerX_d , 4*LAP, ny+2*LAP, nz+2*LAP);
    new_cudaSoA( &pfm_outerY_d , nx+2*LAP, 4*LAP, nz+2*LAP);
    new_cudaSoA( &pfm_outerZ_d , nx+2*LAP, ny+2*LAP, 4*LAP);

    new_cudaField( &pcc_d , nx+2*LAP , ny+2*LAP , nz+2*LAP);
    
    new_cudaField( &pdfp_d , nx , ny , nz);
    new_cudaField( &pdfm_d , nx , ny , nz);
...
void opencfd_mem_finalize_dev(){
    ...
    delete_cudaSoA(pfp_d);
    delete_cudaSoA(pfm_d);

    delete_cudaSoA(pfp_outerX_d);
    delete_cudaSoA(pfp_outerY_d);
    delete_cudaSoA(pfp_outerZ_d);

    delete_cudaSoA(pfm_outerX_d);
    delete_cudaSoA(pfm_outerY_d);
    delete_cudaSoA(pfm_outerZ_d);
...
void opencfd_para_init_dev(){
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Ama_d) ), &Ama , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Gamma_d) ), &Gamma , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(epsl_sw_d) ), &epsl_SW , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Cv_d) ), &Cv , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Cp_d) ), &Cp , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(Tsb_d) ), &Tsb , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(amu_C0_d) ), &amu_C0 , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(dt_d) ), &dt , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(split_C1_d) ), &split_C1 , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(split_C3_d) ), &split_C3 , sizeof(REAL) , 0 , hipMemcpyHostToDevice);


    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(vis_flux_init_c_d) ), &vis_flux_init_c , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(nx_d) ), &nx , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(ny_d) ), &ny , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(nz_d) ), &nz , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(nx_lap_d) ), &nx_lap , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(ny_lap_d) ), &ny_lap , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(nz_lap_d) ), &nz_lap , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(nx_2lap_d) ), &nx_2lap , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(ny_2lap_d) ), &ny_2lap , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(nz_2lap_d) ), &nz_2lap , sizeof(unsigned int) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(hx_d) ), &hx , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(hy_d) ), &hy , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(hz_d) ), &hz , sizeof(REAL) , 0 , hipMemcpyHostToDevice);

    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(WENO_TV_Limiter_d) ), &WENO_TV_Limiter , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
    hipMemcpyToSymbol(HIP_SYMBOL(HIP_SYMBOL(WENO_TV_MAX_d) ), &WENO_TV_MAX , sizeof(REAL) , 0 , hipMemcpyHostToDevice);
