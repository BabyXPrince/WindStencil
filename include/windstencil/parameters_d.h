...
extern cudaSoA *pfp_d; // [5][nz+2*LAP][ny+2*LAP][nx+2*LAP]
extern cudaSoA *pfm_d; // [5][nz+2*LAP][ny+2*LAP][nx+2*LAP]

extern cudaSoA *pfp_outerX_d; // [5][nz+2*LAP][ny+2*LAP][4*LAP]
extern cudaSoA *pfp_outerY_d; // [5][nz+2*LAP][4*LAP][nx+2*LAP]
extern cudaSoA *pfp_outerZ_d; // [5][4*LAP][ny+2*LAP][nx+2*LAP]

extern cudaSoA *pfm_outerX_d; // [5][nz+2*LAP][ny+2*LAP][4*LAP]
extern cudaSoA *pfm_outerY_d; // [5][nz+2*LAP][4*LAP][nx+2*LAP]
extern cudaSoA *pfm_outerZ_d; // [5][4*LAP][ny+2*LAP][nx+2*LAP]
