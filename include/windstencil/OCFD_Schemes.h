...
__device__ REAL OCFD_weno7_SYMBO_kernel_M(int WENO_LMT_FLAG, REAL *stencil);
		__device__ REAL OCFD_weno7_SYMBO_kernel_P_opt(REAL *stencil); // edit by xx.
		__device__ REAL OCFD_weno7_SYMBO_kernel_M_opt(REAL *stencil); // edit by xx.
...
__device__ REAL OCFD_weno5_kernel_P(REAL *stencil);
__device__ REAL OCFD_weno5_kernel_M(REAL *stencil);
	__device__ REAL OCFD_weno5_kernel_P1(REAL *stencil);
	__device__ REAL OCFD_weno5_kernel_M1(REAL *stencil);
