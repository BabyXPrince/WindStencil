...
void du_invis_Jacobian3d_init(cudaJobPackage job_in, hipStream_t *stream);
		...
		void du_invis_Jacobian3d_fpY(cudaJobPackage job_in, cudaSoA *fp, cudaSoA *fm, hipStream_t *stream); // by XX
		void du_invis_Jacobian3d_fpZ(cudaJobPackage job_in, cudaSoA *fp, cudaSoA *fm, hipStream_t *stream); // by XX
		void du_invis_Jacobian3d_x(cudaJobPackage job_in, cudaSoA *fp, cudaSoA *fm, hipStream_t *stream); // by XX
